...
QuickView.prototype.render = function (viewCommand, parameter, ...args) {
  const self = this;
...
QuickView.prototype.connectHandler = function (event, handler) {
  const self = this;
...
QuickView.prototype.paintBar = function (list) {
